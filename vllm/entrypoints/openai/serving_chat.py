...
class OpenAIServingChat(OpenAIServing):
    def __init__(
        ...
        *,
        ...
        self.reasoning_parser: Optional[
        ...
        if reasoning_parser:
            try:
                ...
                raise TypeError(
                    f"{reasoning_parser=} has not been registered"
                ) from e
    ...
    def extract_tool_call_required_streaming(
        ...
        if obj is None or not isinstance(obj, list) or not len(obj) > 0:
            ...
            if not finishes_previous_tool and (
                "name" not in current_tool_call
                or "parameters" not in current_tool_call
            ):
                function_name_returned = False
                delta_message = None
            else:
